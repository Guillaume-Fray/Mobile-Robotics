...
def create_square_track_speeds():
	...
	simWorld.drive_wheel_motors(20, 20)
	time.sleep(150)
	track_speeds.append([-7, 7])
	simWorld.drive_wheel_motors(-7, 7)
	time.sleep(36)
...
def runCozmoMainLoop(simWorld: CozmoSimWorld, finished):
	...
	while not finished.is_set():
		...
		# Save and load file
		np.save("trackSpeeds999", track_speeds)
		# speeds = np.load("trackSpeeds999.npy")
